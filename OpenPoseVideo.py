# -*- coding: utf-8 -*-
"""
Created on Sun Sep  6 09:32:22 2020
    ...
    for pair in POSE_PAIRS:
        ...
        if points[partA] and points[partB]:
            ...
            if partA == 9 and partB == 10:
                ...
                deltaX = points[10][0] - points[9][0]
                deltaY = points[10][1] - points[10][1]
                angle = math.atan2(deltaX, deltaY) / math.pi * 180
                print("Coordinates of point 9 and 10 of right leg:", points[partA], points[partB], "Angle", angle)
                angle_ary = angle
                frame_ary = frame_number
